...
from kycform.services.policy_policies import PolicyPoliciesService


class PolicyPoliciesAPIView(PolicySessionBaseAPIView):
    def get(self, request):
        ...
        data = PolicyPoliciesService.get_policies(client_id)
